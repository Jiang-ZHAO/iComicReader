...
- (void)requestTitleModelCompletion:(void (^)(NSMutableArray *))success
                            failure:(void (^)(NSError *))failure{
    
    NSDictionary *parmas = @{@"method": @"catalogs"};
    
    AFHTTPRequestOperationManager *manager = [AFHTTPRequestOperationManager manager];
    
    
    [manager GET:kNewRequestURL parameters:parmas success:^(AFHTTPRequestOperation *operation, id responseObject) {
