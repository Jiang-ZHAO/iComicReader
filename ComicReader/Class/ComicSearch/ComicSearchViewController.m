...
- (void)touchActionJumpWithParams:(NSString*)params{
    [self.searchBar resignFirstResponder];
    ComicSearchActionViewController *controller = [[ComicSearchActionViewController alloc]initWithNibName:@"ComicSearchActionViewController" bundle:nil];
    controller.searchName = params;
